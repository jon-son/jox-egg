...
//        key4.setOnClickListener( OnClickListener_listener );//设置监听  
    ...
    ImageButton.OnClickListener OnClickListener_listener = new ImageButton.OnClickListener()
    {
		...
		{
			//Toast.makeText(shengjiangji.this, "Enable here="+ v.getId(), Toast.LENGTH_SHORT).show();     
        ...
        public void onClick(View v){    
        	...
        	case R.id.tx_button ://uuid1002 数传通道发送数据
        		...
        		if( mConnected )
        		{
      			  ...
      			  Toast toast = Toast.makeText(shengjiangji.this, "设备没有连接！", Toast.LENGTH_SHORT); 
      			  toast.show(); 
      		  }
        		break;
...
//    		}
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        {
        	 Toast toast = Toast.makeText(shengjiangji.this, "提示！此设备不为JDY系列BLE模块", Toast.LENGTH_SHORT); 
			  toast.show(); 
        }
